...
public class TailRecIfs {
	...
	private final lombok.core.runtimeDependencies.TailCallExpression<BigInteger> fac$internal__(final BigInteger n, final BigInteger ret) {
		if (n.equals(ONE)) return new lombok.core.runtimeDependencies.TailCallExpression.Done<BigInteger>(ret); else return new lombok.core.runtimeDependencies.TailCallExpression.TailCall<BigInteger>(){
