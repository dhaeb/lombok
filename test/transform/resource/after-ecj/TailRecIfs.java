...
public class TailRecIfs {
	...
	private final de.kdi.tailcalls.TailCallExpression<BigInteger> fac$internal__(final BigInteger n, final BigInteger ret) {
		if (n.equals(ONE)) return new de.kdi.tailcalls.TailCallExpression.Done<BigInteger>(ret); else return new de.kdi.tailcalls.TailCallExpression.TailCall<BigInteger>(){
